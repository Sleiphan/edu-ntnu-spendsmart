...
public class FileManagementTest {
    ...
    private User createTestUser1() {
        ...
        Account account1 = new Account(AccountCategory.SAVINGS_ACCOUNT, new BigDecimal("450709.71"), "1203.45.70098", "Savings");
        Account account2 = new Account(AccountCategory.SAVINGS_ACCOUNT, new BigDecimal("2073.01"),   "1040.45.71014", "Spending");

        Invoice invoice = new Invoice(LocalDate.of(3023, Month.AUGUST, 14), new BigDecimal("459.97"), "1501.45.31121", "Stuff");

        Transaction t1 = new Transaction(account1.getAccountNumber(), account2.getAccountNumber(), new BigDecimal("250.00"), "Top up for groceries", LocalDate.of(2023, Month.APRIL, 10), BudgetCategory.FOOD_AND_DRINK);
        Transaction t2 = new Transaction(account2.getAccountNumber(), "2404.43.55015", new BigDecimal("212.78"), "Groceries", LocalDate.of(2023, Month.APRIL, 10), BudgetCategory.FOOD_AND_DRINK);
        Transaction t3 = new Transaction(account1.getAccountNumber(), "2404.43.55015", new BigDecimal("13.00"), "Forgot a pack of chewing gum", LocalDate.of(2023, Month.APRIL, 10), BudgetCategory.LEISURE);

        Budget budget = new Budget((byte) 23, GenderCategory.MALE);
        budget.addBudgetItem(new BudgetItem(new BigDecimal("3100"), "Food", BudgetCategory.FOOD_AND_DRINK));
    ...
    public void initialize() {
        try {
            ...
            FileManagement.TRANSACTION_DAO = new TransactionDAO(testPaths[0], FileManagement.DATA_CHARSET);
