...
public class TestBudgetDAO {
    ...
    public void resetTestData() {
        ...
        budget1.addBudgetItem(new BudgetItem(new BigDecimal("250"), "Candy every saturday", BudgetCategory.LEISURE));
        ...
        budget2.addBudgetItem(new BudgetItem(new BigDecimal("250"), "Candy every saturday", BudgetCategory.LEISURE));
