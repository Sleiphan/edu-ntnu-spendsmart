...
public class TestAccount {
  ...
  @BeforeEach
  public void setUp() {
    account = new Account(AccountCategory.CHECKING_ACCOUNT, new BigDecimal(1000), "1234.56.78910",
        "My Account");
  }
  ...
  public void testEquals() {
    Account account2 = new Account(AccountCategory.CHECKING_ACCOUNT, new BigDecimal(1000),
        "1234.56.78910", "My Account");
    assertEquals(account, account2);

    Account account3 = new Account(AccountCategory.SAVINGS_ACCOUNT, new BigDecimal(1000),
        "1234.56.78910", "My Account");
