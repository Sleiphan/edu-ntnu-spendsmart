 ...
 * account number to pay from, the amount to pay, a description of the transaction, the account
 * number to pay to, a category for the transaction, and a due date for the payment.
 *
 * @author G14
 * @version 1.0
 * @since 2023-04-25
...
public class PaymentScene {
  ...
  static public Scene scene() throws FileNotFoundException, IOException {
    ...
    ComboBox<String> category = ApplicationObjects.newComboBox(categoryChoices, 200, 20, 15,
        x + 130, y + 3 * n);
