...
/**
 * This class represents the scene for transferring money between accounts. It
 * contains a text field for input of the account number to transfer from, the
 * amount to transfer, a description of the transaction, the account number to
 * transfer to, and a category for the transaction.
 *
 * @author G14
 * @version 1.0
 * @since 2023-04-25
