...
/**
 * This class represents a payment object that extends the Transaction class.
 * It contains information about the source and destination accounts, amount, description,
 * customer ID, due date, date of transaction, and category.
 *
 * @author  G14
 * @version 1.0
 * @since 2023-04-25
...
public class Payment extends Transaction {
     ...
     * @param toAccountId       The account number of the account that the money is being transferred to
