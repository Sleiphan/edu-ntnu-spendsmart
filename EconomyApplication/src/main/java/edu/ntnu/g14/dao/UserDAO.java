...
public class UserDAO {
    ...
    * 
    * @return an array of Login objects representing all logins stored in the user data file, or
    *         null if an I/O error occurs while reading data from the file
    * @throws IOException if an I/O error occurs while accessing the file
    */
    ...
    /**
    * Returns the User object with the specified user ID, or null if the ID is not found in the file.
    * 
