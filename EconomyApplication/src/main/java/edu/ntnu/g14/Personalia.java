...
/**
 * A class that represents a person's personal information including login credentials
...
public class Personalia {
    ...
    */
    ...
    /**
    * Returns a blurred version of the email address, where only the first and last characters of the handle are visible 
    * and the rest of the characters are replaced with asterisks.
    * If the email address is null or less than 3 characters long, it will return the original email address.
