...
public class DAOToolsTest {
    ...
    public void insert_into_file_test_common(int position) {
        ...
        String expectedResult = initialTestData.substring(0, position) + insertionString + initialTestData.substring(position);
    ...
    public void replace_common(int start, int count) {
        String insertionString = "Hello World!";
        String expectedResult = initialTestData.substring(0, start) + insertionString + initialTestData.substring(start + count);
