...
public class TransactionDAO {
    ...
    * @throws IOException if there is an error adding the transaction to the IndexedDataFile
    ...
    * @param userID the user ID
    * @return an array of Transaction objects for the user, sorted by time with the latest transaction at the last index,
    * or null if no transactions were found for the user
    ...
    * @return an array of the latest 'amount' number of Transaction objects for the user, sorted by time with the latest transaction at the last index,
    * or null if no transactions were found for the user
    * @throws IOException if there is an error reading the transactions from the IndexedDataFile
    */
